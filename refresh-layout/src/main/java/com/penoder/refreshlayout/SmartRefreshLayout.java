package com.penoder.refreshlayout;
...
import com.penoder.refreshlayout.api.DefaultRefreshFooterCreater;
import com.penoder.refreshlayout.api.DefaultRefreshHeaderCreater;
import com.penoder.refreshlayout.api.RefreshContent;
import com.penoder.refreshlayout.api.RefreshFooter;
...
import com.penoder.refreshlayout.api.ScrollBoundaryDecider;
import com.penoder.refreshlayout.constant.DimensionStatus;
import com.penoder.refreshlayout.constant.RefreshState;
import com.penoder.refreshlayout.constant.SpinnerStyle;
import com.penoder.refreshlayout.footer.ClassicsFooter;
import com.penoder.refreshlayout.header.ClassicsHeader;
import com.penoder.refreshlayout.header.FalsifyHeader;
import com.penoder.refreshlayout.impl.RefreshContentWrapper;
import com.penoder.refreshlayout.impl.RefreshFooterWrapper;
import com.penoder.refreshlayout.impl.RefreshHeaderWrapper;
import com.penoder.refreshlayout.listener.OnLoadmoreListener;
import com.penoder.refreshlayout.listener.OnMultiPurposeListener;
import com.penoder.refreshlayout.listener.OnRefreshListener;
import com.penoder.refreshlayout.listener.OnRefreshLoadmoreListener;
import com.penoder.refreshlayout.util.DelayedRunable;
import com.penoder.refreshlayout.util.DensityUtil;
import com.penoder.refreshlayout.util.ViscousFluidInterpolator;
...
import static com.penoder.refreshlayout.util.DensityUtil.dp2px;
...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    private void initView(Context context, AttributeSet attrs) {
         ...
         */
        int accentColor = ta.getColor(R.styleable.SmartRefreshLayout_srlAccentColor, getResources().getColor(R.color.white));
        int primaryColor = ta.getColor(R.styleable.SmartRefreshLayout_srlPrimaryColor, getResources().getColor(R.color.black));
        if (primaryColor != 0) {
            if (accentColor != 0) {
